...
export function EmptyResults() {
  ...
  return (
    <div className="space-y-5 px-4 py-16 text-center">
      <div className="mx-auto grid h-20 w-20 place-items-center rounded-full bg-bg-secondary">
      ...
      <div className="mx-auto max-w-md space-y-2">
        ...
        <p className="text-sm text-gray-400">
          Tente remover alguns filtros — ou fala com a gente no WhatsApp que a
          gente acha o que você procura.
        </p>
      </div>
